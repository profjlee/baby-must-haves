...
const ITEMS = [
  ...
  // ---- Added 2026-07-09, round 2 ----
  {
    category: "feeding",
    nameEn: "Richell Straw Training Mug",
    nameKo: "리첼 빨대 연습 컵 (스트로 머그)",
    noteEn: "The Japanese straw-training classic — the air valve means no leaks, even on its side.",
    noteKo: "일본 국민 빨대 연습 컵이에요. 공기 밸브 덕분에 옆으로 눕혀도 안 새요.",
  ...
  },
  {
    ...
    noteEn: "A sleeping bag that zips into the stroller — for real winter walks.",
    noteKo: "유모차에 채우는 침낭이에요. 한겨울 산책도 문제없어요.",
    amazonUrl: "",
  ...
  },
  {
    ...
    noteEn: "Warm muffs that strap to the stroller bar — winter walks without losing your gloves.",
    noteKo: "유모차 손잡이에 다는 손토시예요. 장갑 없이도 겨울 산책이 가능해요.",
    amazonUrl: "",
  ...
  },
  {
    ...
    noteEn: "Folds into a backpack and sets up in seconds — travel crib and playpen in one.",
    noteKo: "백팩으로 접혀서 몇 초면 펼쳐져요. 여행용 침대 겸 플레이펜이에요.",
