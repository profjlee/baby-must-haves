...
const ITEMS = [
  ...
  },
  {
    ...
    noteEn: "A Singaporean brand with a genuinely smart product line extension — one container does bottle, pump-storage, and dish duty, quietly cutting the number of SKUs you need to buy.",
    noteKo: "싱가포르 브랜드예요. 영리한 제품 라인 확장이 돋보여요 — 용기 하나가 젖병·유축 보관·식기 역할을 다 해서, 따로 사야 할 제품 가짓수를 줄여줘요.",
    amazonUrl: "",
  ...
  },
  {
    ...
    nameKo: "맘코지 물티슈 워머",
    noteEn: "From Momcozy (USA) — warm wipes mean far fewer midnight tears, theirs and ours.",
    noteKo: "미국 브랜드 맘코지 제품이에요. 따뜻한 물티슈 덕분에 새벽 기저귀 갈이 울음이 확 줄었어요.",
  ...
  },
  {
    ...
    noteEn: "An American brand playing pure cost leadership — featherlight, no-frills, and still passes every crash test that pricier seats do.",
    noteKo: "미국 브랜드예요. 철저한 원가우위 전략 — 가볍고 군더더기 없지만, 비싼 카시트와 똑같은 충돌 테스트를 통과해요.",
    amazonUrl: "",
  ...
  },
  {
    ...
    noteEn: "Also Momcozy (USA) — files tiny nails safely while they sleep, no more clipper anxiety.",
    noteKo: "역시 미국 브랜드 맘코지 제품이에요. 아기가 자는 동안 안전하게 손톱을 갈아줘요. 손톱깎이 공포 끝!",
  ...
  // ---- Added 2026-07-09, round 3 ----
  {
    ...
    noteEn: "A Canadian brand with a real moat — actual traction and grip, unlike most toddler shoes that just look the part.",
    noteKo: "캐나다 브랜드예요. 다른 유아 신발과 달리 실제 접지력이 확실한, 진짜 경쟁력을 갖춘 신발이에요.",
  ...
  },
  {
    ...
    noteEn: "An American publisher's clever pivot — unrippable, chewable 'paper' books that actually survive a toddler's due diligence.",
    noteKo: "미국 출판사의 영리한 피벗이에요. 찢어지지도 씹혀도 멀쩡한 '종이' 그림책 — 아기의 실사를 통과해요.",
  ...
  },
  {
    ...
    noteEn: "An American brand with a sharp value proposition — a full activity center at a fraction of premium competitors' price.",
    noteKo: "미국 브랜드예요. 프리미엄 경쟁 제품 가격의 일부만으로 풀 기능을 제공하는 확실한 가성비템이에요.",
  ...
  },
  {
    ...
    noteEn: "A Hong Kong brand with decades of category dominance — the learning walker every other product line still benchmarks against.",
    noteKo: "홍콩 브랜드예요. 수십 년간 이 카테고리를 지배해온 학습 워커 — 사실상 업계 벤치마크예요.",
  ...
  },
  {
    ...
    noteEn: "Also VTech (Hong Kong) — same playbook, tabletop format, still works.",
    noteKo: "역시 VTech(홍콩) 제품이에요. 같은 전략을 테이블 형태로 옮겼을 뿐, 여전히 효과적이에요.",
  ...
  },
  {
    ...
    noteEn: "The lavender SKU of the same VTech (Hong Kong) walker — twin #2 gets her own unit, no negotiating required.",
    noteKo: "같은 VTech(홍콩) 워커의 라벤더 색상이에요. 쌍둥이 2호도 자기 것이 생겨서 협상할 일이 없어요.",
  ...
  },
  {
    ...
    noteEn: "An American brand solving a real safety concern with an actual mesh solution, not just a marketing claim.",
    noteKo: "미국 브랜드예요. 안전 문제를 마케팅 문구가 아니라 실제 메쉬 소재로 해결해요.",
  ...
  },
  {
    ...
    noteEn: "A simple, low-cost fix for the classic car-seat head-flop problem — high marginal utility for the price.",
    noteKo: "카시트에서 고개가 자꾸 꺾이는 흔한 문제를 해결해주는 저렴하고 심플한 아이템이에요.",
  ...
  },
  {
    ...
    noteEn: "A category-of-one — a breathable blackout tent that actually solves the nap-in-daylight problem, instead of just letting parents complain about it.",
    noteKo: "경쟁자가 딱히 없는 카테고리예요. 낮잠 시간 햇빛 문제를 실제로 해결해주는 통기성 암막 텐트예요.",
  ...
  // ================= FOUND IN ITALY · 이탈리아에서 산 것들 =================
  {
    ...
    noteEn: "An Italian pediatric staple — tasteless macrogol for constipation, the kind of product Italian pharmacists recommend before parents even ask.",
    noteKo: "이탈리아 소아과 상비약이에요. 무맛 마크로골 변비약 — 이탈리아 약사들이 부모가 묻기도 전에 먼저 권해줘요.",
  ...
  },
  {
    ...
    nameKo: "무스텔라 모기 기피제",
    noteEn: "Mustela (France) again, this time solving a very Italian-summer problem — mosquito and tiger-mosquito repellent, safe from 2 months.",
    noteKo: "역시 무스텔라(프랑스) 제품이에요. 이탈리아 여름의 흔한 고민인 모기 문제 해결용 — 생후 2개월부터 사용 가능해요.",
  ...
  },
  {
    ...
    noteEn: "An Italian brand on home turf — roll-on relief for bug bites, a category Chicco basically owns in Italy.",
    noteKo: "이탈리아 브랜드 치코의 홈그라운드 제품이에요. 벌레 물림 진정 롤온 — 이탈리아에서는 사실상 이 카테고리를 장악하고 있어요.",
  ...
  },
  {
    ...
    noteEn: "The same Fisher-Price toy sold everywhere, just multilingual — a nice souvenir that quietly teaches Italian along with English.",
    noteKo: "어디서나 파는 피셔프라이스 장난감인데 다국어 버전이에요. 영어와 함께 이탈리아어도 슬쩍 가르쳐주는 기념품 같은 장난감이에요.",
  ...
  },
  {
    ...
    nameKo: "치코 내추럴Z 방충 젤",
    noteEn: "Also Chicco (Italy) — a citronella-and-eucalyptus gel for the parts of an Italian summer nobody puts in the guidebook.",
    noteKo: "역시 치코(이탈리아) 제품이에요. 가이드북에는 안 나오는 이탈리아 여름의 현실 — 시트로넬라·유칼립투스 방충 젤이에요.",
  ...
  },
  {
    ...
    nameKo: "HiPP 유기농 립밤",
    noteEn: "HiPP (Germany) — organic lip balm for sensitive skin, easy to find in any Italian farmacia.",
    noteKo: "HiPP(독일) 제품이에요. 민감성 피부용 유기농 립밤 — 이탈리아 약국(파르마치아)이라면 어디서나 쉽게 찾을 수 있어요.",
  ...
  },
  {
    ...
    nameKo: "멘타덴트 키즈 치약",
    noteEn: "An Italian brand — kids' toothpaste with a cartoon-character bribe built in, 97% natural-origin ingredients.",
    noteKo: "이탈리아 브랜드예요. 캐릭터로 아이를 구슬리는 어린이 치약 — 성분의 97%가 천연 유래예요.",
  ...
  },
  {
    ...
    noteEn: "Chicco (Italy) again — a battery-powered ultrasonic clip-on, no chemicals, no spray, just quiet engineering against mosquitoes.",
    noteKo: "역시 치코(이탈리아) 제품이에요. 배터리로 작동하는 초음파 클립형 — 화학성분도 스프레이도 없이 조용히 모기를 막아줘요.",
